// urls
export const LINKEDIN_URL = "https://www.linkedin.com/in/pavan-patel9";
...
export const PROJECT_DESP_2 = "Amazing Website that you are currently viewing is hosted on Github Pages";
export const PROJECT_TOOLS_2 = "ReactJs, HTMl, CSS";
...
export const PROJECT_TITLE_4 = "SENTIMENT ANALYSIS ON COVID-19";
export const PROJECT_DESP_4 =
  "Developed a Console application that gathers tweets from twitter users worldwide and stores them in a file.";
...
export const PROJECT_DESP_5 =
  "An embedded system developed to prevent accidents. The Embedded system has python-based drowsiness detection, a valid driver authenticator with raspberry, and an Arduino-based drunkenness detection system.";
export const PROJECT_TOOLS_5 = "ReactJs, HTMl, CSS";
