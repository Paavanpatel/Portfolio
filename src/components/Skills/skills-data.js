export default [
  ...
  { name: "Go", icon: require("../../icons/golang-icon.svg"), alt: "Go Icon" },
  ...
  { name: "CSS", icon: require("../../icons/css-icon.png"), alt: "CSS Icon" },
  ...
  { name: "Linux", icon: require("../../icons/linux-icon.png"), alt: "Linux Icon" },
